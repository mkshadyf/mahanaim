      ...
      <Grid mb="xl">
        <Grid.Col span={6}>
          <Paper withBorder p="md" radius="md">
            <Text style={{ fontSize: '1.125rem', fontWeight: 500, marginBottom: '1rem' }}>
              {t('receivables')}
            </Text>
            <Box style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                ...
                <Text style={{ fontSize: '0.875rem', color: 'dimmed' }}>
              ...
              <RingProgress
                ...
                sections={[
                  {
                    value:
                      (totals.receivableUSD / (totals.receivableUSD + totals.payableUSD)) * 100,
                    color: 'blue',
                  },
                ]}
              />
            ...
            <Box style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <RingProgress
                ...
                sections={[
                  {
                    value:
                      (totals.payableUSD / (totals.receivableUSD + totals.payableUSD)) * 100,
                    color: 'red',
                  },
                ]}
              />
